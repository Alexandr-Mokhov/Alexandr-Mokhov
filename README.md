...
Я Frontend-разработчик, который верит, что качественный код — это не только производительность, но и забота о пользователе.  
🛠️ Создаю быстрые, интуитивно понятные и визуально приятные интерфейсы.  
🌱 Внедряю актуальные фреймворки, библиотеки и практики в свои проекты.  
🚀 Прошел путь от пет-проектов и фриланса до командной разработки в крупной продуктовой IT-компании.  
